...
public class Main extends JFrame implements IObservable 
{
	...
	public Main() throws BadDataException
	{
		setSize(600, 700);//set the size of the window to 600 x 800
		...
		for (int i=0; i<iShapes.size(); i++){
			iShapeList.add(iShapes.get(i));
		}
		
		}	//TODO - Add the above iShapes collection to your singleton
	

	public Main getHomeworkThree()
	{
		return this;
	}
	public void update() 
	...
	public static void main(String[] args) throws BadShapeException, BadDataException
	{
